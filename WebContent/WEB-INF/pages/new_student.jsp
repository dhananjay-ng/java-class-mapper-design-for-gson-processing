                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <h2 class="text-center login-title">New Student</h2>
                            <hr>
                            ...
                            <form method="post" action="/newStudent" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="id" class="form-control" hidden id="id" placeholder="id" name="id" value="${student.id}">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-lg-6">
                                    <input type="submit" name="action" value="Add" class="btn btn-md btn-primary btn-block text-center " />
